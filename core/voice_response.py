...
if sys.platform == "win32":
    from control.windows.voice_response import speak, speak_and_wait, is_speaking
else:
    # from control.linux.voice_response import speak, speak_and_wait, is_speaking
    # from control.mac.voice_response import speak, speak_and_wait, is_speaking
